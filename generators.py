...
class FrequencyBasedGenerator:
    ...
    def __init__(self, dictonary):
        assert len(dictonary)>0, "FrequencyBasedGenerator needs non-empty generator to work!"
        assert any(i > 0 for i in dictonary.values()), "Dictionary needs at least one positive weight to work"
